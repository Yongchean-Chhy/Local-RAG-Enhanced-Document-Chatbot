This project implements a chatbot that leverages Ollama and Retrieval-Augmented Generation (RAG) to extract relevant information from uploaded PDF files. 
